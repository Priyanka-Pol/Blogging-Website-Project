const createBlog = document.querySelector(".creating-blog");/* for accessing the element from DOM */
...
createBlog.addEventListener('click',createModal); /* Event listner for clicking button on functions which is made above */
...
function editPost(id){ /* function for edding Post with the help of Id */
...
function saveEditPost() { /* function for Saving the eddted Post with the help of Id */
